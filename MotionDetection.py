...
class MotionDetection:
    ...
    def __init__(self, video_path=None, a=0.95, c=2, initial_threshold=40):
        ...
        if video_path is None:
            # Use camera if video_path is None
        ...
        self.model.load_model("tuned_model.json")
    ...
    def draw_rectangles(self):
        ...
        for degree, moving_rectangles_degree in enumerate(
            ...
            for rectangle_index in moving_rectangles_degree:
                ...
                fts = np.array([get_wavelet_features(image)])
    ...
    def fit(self):
        ...
        while self.run:
            ...
            # drawing moving regions with probabilities of the fire being placed above
