...
class motiondetection:
    ...
    def fit(self, video = False, toshow = True):
        ...
        while self.fitting: #until stop() is called run this
            ...
            self.contours, _ = cv2.findContours(dilated.copy(), cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)
